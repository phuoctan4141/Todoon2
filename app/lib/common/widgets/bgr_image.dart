...
class BgrImage extends StatelessWidget {
  ...
  const BgrImage({super.key, required this.child, this.isFill = false});

  @override
  Widget build(BuildContext context) {
    final bgrImage = AssetImage(
      context.theme.brightness == .light
          ? (isFill ? ImageAssets.background_light : ImageAssets.bgr_light)
          : (isFill ? ImageAssets.background_dark : ImageAssets.bgr_dark),
    );
